...
<div id="pendapatan">
	...
	<div class="container" style="margin-top: 55px">
		<div class="card mt-5">
			<div class="card-body">
				<h4>Realisasi Pendapatan <?php echo $name; ?> </h4>
				<br>
...
<div id="belanja" class="collapse">
	...
	<div class="container" style="margin-top: 55px">
		<div class="card mt-5">
			<div class="card-body">
				<h4>Realisasi Anggaran Belanja <?php echo $name; ?> </h4>
				<br>
...
<script>
    ...
    series: [{
        ...
        data: [{
            ...
            if($summaryrealpendapatan[0]['realiasipendapatan'] == 0 || $summaryanggpendapatan[0]['anggaranpendapatan']){
            	$nilaireal = 0;
            }
            else{
            	$nilaireal = $summaryrealpendapatan[0]['realiasipendapatan']/$summaryanggpendapatan[0]['anggaranpendapatan'];
            }

              echo number_format(($nilaireal*100), 2, '.', ''); ?> 
        }, {
            ...
            if($summaryrealpendapatan[0]['realiasipendapatan'] == 0 || $summaryanggpendapatan[0]['anggaranpendapatan']){
            	...
            	$nilaiblmreal = $summaryrealpendapatan[0]['realiasipendapatan']/$summaryanggpendapatan[0]['anggaranpendapatan'];

            }

             echo number_format(($nilaiblmreal*100), 2, '.', ''); ?>
        }]
    }]
});
