...
<html>
    ...
    <body style="background-color:   #3A5BA0;">
            <div class="row" style="padding-top: 15%; ">
                    <div class="col-md-4"></div>
                    <div class="col-md-4">
                        <div class="panel" style="background-color: #1F4690;">
                            <div class="panel-body">
                                <center>
                                    <h1 class="form-title font-awesome" style="color: #fff;">Report APBD</h1>
                                
                                <?php echo isset($message) ? $message : ''; ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-8 col-sm-offset-2">
                                            <form action="<?php echo base_url(); ?>/do_login2" method="post" accept-charset="UTF-8" role="form">
                                                <fieldset>
